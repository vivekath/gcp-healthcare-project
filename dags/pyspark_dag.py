...
GCS_JOB_FILE_1 = f"gs://{COMPOSER_BUCKET}/dags/INGESTION/jobs/pyspark/hospitalA_mysqlToLanding.py"
PYSPARK_JOB_1 = {
...
GCS_JOB_FILE_2 = f"gs://{COMPOSER_BUCKET}/dags/INGESTION/jobs/pyspark/hospitalB_mysqlToLanding.py"
PYSPARK_JOB_2 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
...
GCS_JOB_FILE_3 = f"gs://{COMPOSER_BUCKET}/dags/INGESTION/jobs/pyspark/claims.py"
PYSPARK_JOB_3 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
...
GCS_JOB_FILE_4 = f"gs://{COMPOSER_BUCKET}/dags/INGESTION/jobs/pyspark/cpt_codes.py"
PYSPARK_JOB_4 = {
    "reference": {"project_id": PROJECT_ID},
    "placement": {"cluster_name": CLUSTER_NAME},
